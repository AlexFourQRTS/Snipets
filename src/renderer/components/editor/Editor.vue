...
onMounted(() => {
  // Ленивая инициализация редактора для улучшения производительности
  nextTick(() => {
    init()
  })
})
...
<template>
  <div
    data-editor
    class="grid grid-rows-[auto_1fr_auto] overflow-hidden"
  >
...
.CodeMirror {
  ...
  height: 100%;
  background-color: var(--color-markdown-code) !important;
  border-radius: 6px;
  padding: 15px;
...
.CodeMirror .cm-keyword { color: #c678dd; } /* keyword */
.CodeMirror .cm-string { color: #98c379; } /* string */
.CodeMirror .cm-function { color: #61afef; } /* function */
.CodeMirror .cm-comment { color: #5c6370; } /* comment */
.CodeMirror .cm-number { color: #d19a66; } /* number */
.CodeMirror .cm-variable { color: #e06c75; } /* variable */
.CodeMirror .cm-property { color: #56b6c2; } /* property */
</style>
