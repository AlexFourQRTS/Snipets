...
export function useDB() {
  ...
  const storageDir = store.preferences.get('storagePath')
  ...
  try {
    ...
    db.exec(`
      CREATE INDEX IF NOT EXISTS idx_snippets_folder_id ON snippets(folderId);
      CREATE INDEX IF NOT EXISTS idx_snippets_is_deleted ON snippets(isDeleted);
      CREATE INDEX IF NOT EXISTS idx_snippets_is_favorites ON snippets(isFavorites);
      CREATE INDEX IF NOT EXISTS idx_snippets_created_at ON snippets(createdAt);
      CREATE INDEX IF NOT EXISTS idx_snippets_updated_at ON snippets(updatedAt);
      CREATE INDEX IF NOT EXISTS idx_snippets_name ON snippets(name);
      CREATE INDEX IF NOT EXISTS idx_snippet_contents_snippet_id ON snippet_contents(snippetId);
      CREATE INDEX IF NOT EXISTS idx_snippet_contents_language ON snippet_contents(language);
      CREATE INDEX IF NOT EXISTS idx_folders_parent_id ON folders(parentId);
      CREATE INDEX IF NOT EXISTS idx_folders_order_index ON folders(orderIndex);
      CREATE INDEX IF NOT EXISTS idx_tags_name ON tags(name);
      CREATE INDEX IF NOT EXISTS idx_snippet_tags_snippet_id ON snippet_tags(snippetId);
      CREATE INDEX IF NOT EXISTS idx_snippet_tags_tag_id ON snippet_tags(tagId);
    `)
    ...
    console.error('Storage path:', store.preferences.get('storagePath'))
    console.error('DB path:', dbPath)
    console.error('Storage dir exists:', fs.existsSync(storageDir))
